...
const outputPath = path.resolve(__dirname, '../../cms/public/build/plugins/newsletter');
...
export default {
    ...
    output: {
        path: outputPath,
        publicPath: '/build/plugins/newsletter/',
        uniqueName: 'newsletter_admin',
    },
    module: {
        rules: [
            {
    ...
    plugins: [
        new webpack.container.ModuleFederationPlugin({
            ...
            // Only consumes the admin host's shared RichTextEditor - no
