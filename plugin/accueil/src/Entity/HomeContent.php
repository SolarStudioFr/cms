...
namespace Plugin\Accueil\Entity;
...
use Plugin\Accueil\State\HomeContentProvider;
use Symfony\Component\Serializer\Attribute\Groups;

/**
 * The homepage's own content (step 21) - a singleton, unlike the list-based
 * content plugins (Page, Realisations, Actualites): there is always exactly
