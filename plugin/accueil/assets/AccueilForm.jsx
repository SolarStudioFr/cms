 ...
 * unlike PageForm/RealisationForm/ActualiteForm there is no list, no
 * title, no status: just the content editor and a save button, always
 * PATCHing the same `/admin/home` resource (auto-created on first read).
 */
    ...
    return (
        <div>
            ...
            <Form onSubmit={handleSubmit} style={{ maxWidth: '640px' }}>
                <Form.Group className="mb-3" controlId="accueilContent">
