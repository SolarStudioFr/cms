...
class ActualiteAdminApiTest extends WebTestCase
{
    ...
    public function testFullCrudLifecycleAsAdmin(): void
    {
        ...
        $client->jsonRequest('POST', '/api/admin/actualites', [
        ...
        $client->request('GET', '/api/admin/actualites');
        self::assertResponseIsSuccessful();
        ...
        $client->request('DELETE', "/api/admin/actualites/{$id}");
        self::assertResponseStatusCodeSame(204);

        $client->request('GET', "/api/admin/actualites/{$id}");
    ...
    public function testBuilderDataDefaultsToNullForTheFallbackEditor(): void
    {
        ...
        $client->jsonRequest('POST', '/api/admin/actualites', ['title' => 'Fallback', 'content' => 'Plain text']);
        self::assertResponseIsSuccessful();
    ...
    public function testAnonymousCannotListAdminActualites(): void
    {
        $client = static::createClient();
