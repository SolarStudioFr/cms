...
/**
 * Admin language manager (step 07, translated at step 54, kept as its own
 * page per explicit user correction of step 55): lists every Lang, lets the
 * admin add one, toggle it active/inactive (i.e. listed by the public
 * GET /api/langs - see ActiveLangCollectionProvider), or delete it.
 * Configuration (SiteConfig.jsx) only adds a single "default language"
 * selector alongside this, it does not duplicate this CRUD.
 */
export default function LangManager() {
    ...
    return (
        <div>
            <h1 className="mb-4">{t('languages.title')}</h1>
