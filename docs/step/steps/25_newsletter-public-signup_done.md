# Étape 25 — Inscription newsletter — public

> Statut : **done** (v0.23.0).
> Ne pas démarrer sans demande explicite de l'utilisateur.

**Fonctionnalité** : Newsletter (plugin, avec une brique générale)
**Slug** : `newsletter-public-signup`

## Objectif

Inscription à la newsletter côté visiteur (site public).

## Portée / dépendances

Dépend de 23 (`newsletter-plugin-admin`, pour le modèle d'abonné). Fait partie du même plugin (voir note sur 23).
