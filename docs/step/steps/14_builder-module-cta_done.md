# Étape 14 — Module Appel à l'action (CTA)
...
**Slug** : `builder-module-cta`

## Objectif

Bouton/bloc de conversion pour le builder.

## Portée / dépendances

Dépend de 10 (`builder-core`). Fait partie du plugin unique du builder.
...
Fait en version 0.14.0. Voir `docs/RELEASE.md`. Exécutée dans le cadre de l'enchaînement des étapes 06 à 16 autorisé par l'utilisateur (session du 2026-09-04).
