# Étape 19 — Plugin Actualités — admin
...
**Slug** : `plugin-actualites-admin`

## Objectif

CRUD admin du plugin Actualités (articles de blog/news).

## Portée / dépendances

**Les étapes 19 et 20 constituent un seul et même plugin Actualités.** Utilise l'éditeur générique (09) par défaut, remplacé par le builder (10+) s'il est actif. Bloquant pour 20.
...
Voir `docs/RELEASE.md` (0.19.0). Copie conforme du plugin Réalisations.
