...
**Slug** : `builder-module-image`

## Objectif

Module Image simple pour le builder.

## Portée / dépendances

Dépend de 10 (`builder-core`) et 03 (`media-picker-component`, pour la sélection/ajout d'image). Fait partie du plugin unique du builder (voir note sur 10).
...
Fait en version 0.11.0. Voir `docs/RELEASE.md`. Exécutée dans le cadre de l'enchaînement des étapes 06 à 16 autorisé par l'utilisateur (session du 2026-09-04).
